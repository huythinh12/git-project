...
function scrollFunction() {
    ...
    if (document.body.scrollTop > 1000 || document.documentElement.scrollTop > 1000) {
        document.getElementById("progress-animation1").style.animation = "yourAnimation1 0.9s 1 0s linear";
        document.getElementById("progress-animation1").style.width = "80%"
    }

    if (document.body.scrollTop > 1000 || document.documentElement.scrollTop > 1000) {
        document.getElementById("progress-animation2").style.animation = "yourAnimation2 0.9s 1 0s linear"
        document.getElementById("progress-animation2").style.width = "90%"
    }
    if (document.body.scrollTop > 1000 || document.documentElement.scrollTop > 1000) {
        document.getElementById("progress-animation3").style.animation = "yourAnimation3 0.9s 1 0s linear"
